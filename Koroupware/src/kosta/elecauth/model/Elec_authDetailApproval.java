...
public class Elec_authDetailApproval implements Serializable {
	...
	public Elec_authDetailApproval(){}

	public Elec_authDetailApproval(int elec_auth_no, int emp_no, String approval_list_pass, int approval_list_step,
