...
public class Elec_authListCond implements Serializable{
	private int emp_no;
	...
	public Elec_authListCond(){}

	public Elec_authListCond(int emp_no, boolean isReceive, String condition) {
		super();
		this.emp_no = emp_no;
	...
	public Elec_authListCond(int emp_no, boolean isReceive, int condition) {
		super();
		this.emp_no = emp_no;
		this.isReceive = isReceive;
