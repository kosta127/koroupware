...
public class EmpMember {
	...
	public EmpMember(String emp_no, String emp_name, String dept_no, String emp_email, String emp_superior,
			String emp_reporter, String emp_id, String emp_password, String emp_address, String emp_approvalyn,
			String emp_residentnumber, String emp_hiredate, String position_no, String office_no, String emp_email_sign,
			String emp_elec_auth_signkey, String emp_img, String emp_elec_auth_img) {
		super();
		this.emp_no = emp_no;
	...
	public void setEmp_superior(String emp_superior) {
		this.emp_superior = emp_superior;
	}

	public String getEmp_reporter() {
		return emp_reporter;
	}

	public void setEmp_reporter(String emp_reporter) {
		this.emp_reporter = emp_reporter;
	}
