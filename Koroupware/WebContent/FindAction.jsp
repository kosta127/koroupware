		...
		<div class="row1">
			<div class="col-xs-5">
				...
				<form action="FindIdProcess.do" method="post">
						...
						<span class="residentnumber">주민번호</span> <input type="text"
							name="find_RESIDENTNUMBER" class="form-control">
		...
		<div class="row2">
			<div class="col-xs-5">
				...
				<form action="FindPasswordProcess.do" method="post">
						...
						<span class="my-id">아이디</span> <input type="text" name="find_id" class="input-id form-control">
