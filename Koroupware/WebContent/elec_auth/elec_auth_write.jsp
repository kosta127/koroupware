...
<body>
	<div class="container">
		...
		<form id="elec_auth_form" action="elec_authSubmission.do" method="post" class="form-horizontal">
			<!-- 작성자 -->
			...
			<div id="manage_dept_div" class="form-group">
				...
				<div class="col-xs-10 col-lg-10">
					<input type="text" name="management_dept_name" id="management_dept_name" value="${empDetail.dept_name }" readonly="readonly" class="form-control">
