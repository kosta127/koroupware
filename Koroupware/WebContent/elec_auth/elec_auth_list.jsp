			...
			<div id="elec_auth_box">
				<div class="panel panel-default">	
					<div class="panel-heading">
        				<h3 class="panel-title"><a href="elec_authList.do">내가 올린 결재</a></h3>
      				</div>
					<div class="panel-body">
						<ul id="write_list" class="nav nav-pills nav-stacked">
							<li><a href="elec_authList.do?flag=ing">진행중인 결재</a></li>
							<li><a href="elec_authList.do?flag=done">완료된 결재</a></li>
							<li><a href="elec_authList.do?flag=ret">부결/반려된 결재</a></li>
							<li><a href="elec_authList.do?flag=temp">임시저장 결재</a></li>
						</ul>
					</div>
				</div>			
				<div class="panel panel-default">
					<div class="panel-heading">
        				<h3 class="panel-title"><a href="elec_authList.do?receive=ok">내가 받은 결재</a></h3>
      				</div>
      				<div class="panel-body">
						<ul id="receive_list" class="nav nav-pills nav-stacked">
							<li><a href="elec_authList.do?receive=ok&flag=wait">결재대기중인 결재</a></li>
							<li><a href="elec_authList.do?receive=ok&flag=ing">진행중인 결재</a></li>
							<li><a href="elec_authList.do?receive=ok&flag=done">완료된 결재</a></li>
							<li><a href="elec_authList.do?receive=ok&flag=ret">부결/반려한 결재</a></li> 
						</ul>
					</div>
				</div>	
			</div>
